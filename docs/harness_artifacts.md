...
projection and the error ladder keep the attempted action. A finding from an
imported instruction file occurs at turn zero and has no synthetic
`tool_call` row.
