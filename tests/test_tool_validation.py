...
VALID_ARGUMENTS = {
    ...
    "subagent_changes": {"task_id": "task-000001", "offset": 0, "limit": 200},
...
INVALID_ARGUMENTS = (
    ...
    ("structural_search", {}, "$.path", "required"),
    (
        "structural_search",
        {"path": ".", "language": "ruby", "query": "(identifier) @match"},
        "$.language",
        "enum",
    ),
    ...
    ("subagent_changes", {}, "$.task_id", "required"),
    ("subagent_changes", {"task_id": 7}, "$.task_id", "type"),
    ("apply_subagent", {}, "$.task_id", "required"),
    ("apply_subagent", {"task_id": 7}, "$.task_id", "type"),
