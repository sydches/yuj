...
- You can attach exact repository text files or directories when you start a
  session.
- You can attach one GitHub issue or pull request as bounded, untrusted,
...
| `yuj --github OWNER/REPOSITORY#NUMBER "TASK"` | Attach one read-only GitHub issue or pull request to a new task. |
